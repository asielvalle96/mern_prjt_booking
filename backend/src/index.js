...
app.use(cookieParser()) // Now I can send the token to the cookies of the browser (res.cookie).

app.use('/api/hotels', hotelsRoute)
app.use('/api/auth', authRoute)
app.use('/api/users', usersRoute)
app.use('/api/rooms', roomsRoute)
// Error handling ---- Handler of the "next" in the controllers. All errors get out with the same format.
